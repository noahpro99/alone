...
public final class Loadout {
    ...
    private static final List<Choice> CHOICES = List.of(
        ...
        new Choice("tarp", "9 m² of tarp — waterproof, fireproof shelter",
            () -> List.of(new ItemStack(AloneItems.TARP, 9))),
        ...
        new Choice("knife", "Steel knife — a real blade for butchering",
            () -> List.of(new ItemStack(AloneItems.STEEL_KNIFE))),
