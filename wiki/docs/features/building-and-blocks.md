...
- **The digging stick is the pre-shovel aid.** Before you can knap a shovel, craft a **digging stick** (a **stick + a flint shard** — a fire-hardened point): jabbing and levering with it turns packed earth **~2.5× faster than clawing by hand**, though still well short of a real shovel. It also clears turf as quick as a hoe. The hard use blunts and splits it, so it **wears out and snaps** — a crude, renewable stopgap, not a lasting tool.
