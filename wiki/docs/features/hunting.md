...
Wild animals don't stand around to be clubbed, and meat isn't free. Hunting is a craft of stealth,
...
- **You can't tower up and snipe it.** Throw up a taller pillar to shoot it with a bow from safety and it **digs the pillar out from under you** — loose earth has no cohesion, so an undermined dirt tower **collapses and drops you** back into its reach. (A proper fortified position — natural high ground, or stone/obsidian you actually built — still gives you the archer's advantage; a flung-up dirt column doesn't.)
- **It won't stand in the open eating arrows.** Shoot it from range and — if it has a clear path to you — it just **charges**, closing the distance fast (it'll hunt you from a good way off). Only when the direct approach is **blocked** does it **break for cover** instead, working its way in behind anything solid — and because it's a **~2.7 m construct**, it takes *real* cover (something tall enough to hide it, not a one-block wall) to screen it. Either way, sniping from range only buys you time until it's on you.
