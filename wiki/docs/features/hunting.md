...
- **It won't stand in the open eating arrows.** Shoot it from a distance and it doesn't just walk toward you across the field — it **breaks for cover**, putting something solid between you and it, and works its way in *behind* cover. In open ground with nothing to hide behind it simply charges. Either way, sniping it from range only buys you time until it's on you.
