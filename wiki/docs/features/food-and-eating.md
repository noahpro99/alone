...
Eating keeps hunger up, but *what*, *how*, and *when* you eat all matter — raw food can cause sickness, meals take real time, and a monotonous diet stops filling you up.

## Raw food is risky

Eating raw meat can cause a foodborne illness. Cooking makes food **safe**.
...
- **You cannot eat while sprinting.**
- Eating takes **real time** — about **3× longer than vanilla**, so a snack takes roughly **5 seconds**.

## Hygiene — dirty hands

Handling raw meat leaves a mess:

- **Butchering dirties your hands.**
- **Eating with dirty hands adds ~25% sickness** to any food, even cooked.
- **Drinking water washes the hands clean.**
...
Foods belong to groups — **protein, vegetable, grain, fruit**. Eating the same group repeatedly burns you out on it:

- Repeatedly eating one group **raises that group's fatigue**.
