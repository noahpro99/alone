...
- [x] **Free-climbing (§5.4)** — new ways up/down: **leaves work like scaffolding** — you stand on top of a canopy but climb up (or crouch down) *through* it, no stamina cost; and you can **scrabble up OR down any flat full-block wall** (no height limit). Wall-climbing is **slow rock-climbing pace** (~0.45× ladder speed) and **brutally strenuous** — clinging drains stamina every tick in either direction, and **when you run out you lose your grip and fall**. **Too much weight (>~25 kg) and you can't climb at all.** Real ladders/vines keep vanilla speed. (`Climbing`, `LivingEntityClimbMixin`, `LeavesCollisionMixin`.)
