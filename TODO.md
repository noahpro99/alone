...
- [x] **Salt water (§1.2)** — ocean-biome water is salt: drinking it bare-handed *or* from a waterskin **dehydrates** you instead of quenching (rivers/lakes stay fresh). Filling a waterskin from the ocean stores it as `SALT`; **boiling it over a campfire desalinates it to clean**. (`Drinking.isSaltWater`, `WaterskinItem`.)
